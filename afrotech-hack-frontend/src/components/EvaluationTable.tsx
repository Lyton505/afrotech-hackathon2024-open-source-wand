    ...
    const evaluationMock = [
        {
            ...
            criteria: [
                {
                    name: "Readability",
                    sample: "def f(x,y,z):return[i for i in range(x)if i%y==0 and sum([int(j)for j in str(i)])==z]",
                    score: 10,
                    link: "https://github.com/lyton505/afrotech-hack-frontend/blob/main/src/components/EvaluationTable.tsx"
                },
                {
                    name: "Linting errors",
                    sample: "function add(a,b){return a+b}  // Missing spaces after commas and around operators",
                    score: 90,
                    link: "https://github.com/lyton505/afrotech-hack-frontend/blob/main/src/components/EvaluationTable.tsx"
                }
            ]
            ...
            criteria: [
                {
                    ...
                    sample: "int totalAmount = 0; // Good variable naming for total amount\nString userName = \"JohnDoe\"; // Clear and descriptive variable name for user",
                    score: 100,
                    link: "https://github.com/lyton505/afrotech-hack-frontend/blob/main/src/components/EvaluationTable.tsx"
                },
                {
                    name: "Code comments",
                    sample: "// Destructor for the MyClass class\n" +
                    "~MyClass() {\n" +
        ...
        <Table>
            ...
            <TableBody>
                {evaluationMock.map((evaluation) => (
                    <><TableRow className="hover:bg-gray-100 text-left" key={evaluation.metric}>
                        ...
                        <TableCell className="font-normal text-left text-base">{evaluation.metric}</TableCell>
                        <TableCell className="text-center text-base font-bold">{evaluation.score} / 100</TableCell>
                    ...
                    {evaluation.criteria.map((criteria) => (
                        <TableRow>
                            <TableCell className="font-normal text-center text-sm">{criteria.name}</TableCell>
            ...
            <TableFooter>
                <TableRow className="bg-gray-100 p-16 rounded-xl">
                    <TableCell colSpan={2} className="text-left font-bold text-lg">Weighted Total</TableCell>
                    <TableCell className="text-right font-bold text-lg">92.75 / 100</TableCell>
                </TableRow>
            </TableFooter>
        </Table>
    )
